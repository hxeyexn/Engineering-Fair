...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer1 = MediaPlayer.create(MainActivity.this, R.raw.alarm);
        ...
        String lai = String.valueOf(cur_lat);
        String lon = String.valueOf(cur_lon);
        Log.w("현재위도", lai);
        Log.w("현재경도", lon);
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    for (DataSnapshot child: postSnapshot.getChildren()){
                        if(child.child("Scan").getValue() != null) {
                            ...
                            String device1 = String.valueOf(user.DeviceNo);
                            Log.w("db위도", laitu);
                            Log.w("db경도", longit);
                            Log.w("db디바이스",device1);
                            Log.w("db시간",user.Time);
